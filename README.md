Access your virtual machine (VM) 
...
ii. Allow SSH traffic using the command: 
sudo ufw allow ssh 
iii. Enable the firewall: 
sudo ufw enable 
...
Then type the user_name’s password that you set. 
...
git clone -b MCO2 https://github.com/ilovestudying123/CCDEVAP-S16-4-CafeAnoTara.git
...
ALTER USER 'root'@'localhost' IDENTIFIED WITH auth_socket BY 'abc123'; 
SET PASSWORD FOR 'root'@localhost = PASSWORD("abc123"); 
GRANT ALL PRIVILEGES ON *.* TO 'root'@'localhost' WITH GRANT OPTION; 
CREATE USER 'root'@'192.168.%.%' IDENTIFIED BY 'abc123';
ALTER USER 'root'@'192.168.%.%' IDENTIFIED WITH auth_socket BY 'abc123'; 
SET PASSWORD FOR 'root'@'192.168.%.%' = PASSWORD("abc123"); 
GRANT ALL PRIVILEGES ON *.* TO 'root'@'192.168.%.%' WITH GRANT OPTION; 
CREATE USER 'root'@'10.%.%.%' IDENTIFIED BY 'abc123'; 
ALTER USER 'root'@'10.%.%.%' IDENTIFIED WITH auth_socket BY 'abc123'; 
SET PASSWORD FOR 'root'@'10.%.%.%' = PASSWORD("abc123"); 
